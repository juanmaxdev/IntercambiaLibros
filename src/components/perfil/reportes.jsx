...
export default function Reportes() {
  ...
  const [reporteEnviado, setReporteEnviado] = useState(false); // ✅ NUEVO
  ...
  const validate = () => {
    ...
    if (!formValues.mensaje.trim()) {
      ...
      newErrors.mensaje =
        "El mensaje debe contener al menos 20 caracteres para explicar detalladamente el motivo.";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.ok) {
      setReporteEnviado(true); // ✅ Mostrar mensaje
      setTimeout(() => setReporteEnviado(false), 5000); // ⏱️ Ocultar después de 5s
        ...
        <div className="col-12 col-lg-10">
          <div className="row gx-lg-5">
            ...
            <div className="col-12 col-xl-5 order-1 order-xl-0">
              ...
              <p>
                En nuestra página, queremos garantizar un ambiente seguro y agradable para todos los usuarios...
              </p>

              {/* instrucciones... (omitidas por brevedad) */}
